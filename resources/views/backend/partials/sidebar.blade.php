            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub {{ Request::is('reports*') ? 'active open' : '' }}">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide">
                            <a href="{{ route('reports.employee-orders') }}" class="side-menu__item {{ Request::is('reports/employee-orders*') ? 'active' : '' }}">
                                Employee Orders
                            </a>
                        </li>
                        <li class="slide">
                            <a href="{{ route('reports.orders-status-product') }}" class="side-menu__item {{ Request::is('reports/orders-status*') ? 'active' : '' }}">
                                Orders Status (Products)
                            </a>
                        </li>
                        <li class="slide">
                            <a href="{{ route('reports.orders-product') }}" class="side-menu__item {{ Request::is('reports/orders-product*') ? 'active' : '' }}">
                                Orders (Products)
                            </a>
                        </li>
                    </ul>
